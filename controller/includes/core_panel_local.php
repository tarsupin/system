...
<div id="panel-core">
	<div id="core-nav">
		<ul id="core-list">
			...
			<li class="core-link is-feed"><a href="http://feed.unifaction.me.test/' . $xQ . '"><span class="icon-document core-icon"></span><span class="core-txt">My Feed</span></a></li>
			<li class="core-link is-my_uni"><a href="http://unifaction.me.test/' . $xQ . '"><span class="icon-globe core-icon"></span><span class="core-txt">My Uni</span></a></li>
			...
			<li class="core-link"><a href="http://unifaction.test/games' . $xQ . '"><span class="icon-gamepad core-icon"></span><span class="core-txt">Games</span></a></li>
		</ul>
	</div>
</div>');
