...
/****** Output the list of comments for this content entry ******/
	...
	(
		$contentID			// <int> The ID of the content entry to output the comment section for.
	,	$postURL			// <str> The URL to post to (the form action).
	,	$commentLevel = 2	// <int> The comment level (e.g. Content::COMMENTS_STANDARD)
...
/****** Draw the form for this comment system ******/
	...
	(
		$contentID		// <int> The ID of the content entry to output the comment form for.
	,	$postURL		// <str> The URL to post to (the form action).
	)					// RETURNS <void> outputs the appropriate data.
...
/****** Run the comment intepreter (such as if you post a comment) ******/
	...
	(
		$contentID			// <int> The ID of the content entry that this interpreter is running for.
...
/****** Create a Comment ******/
	...
	(
		$contentID		// <int> The ID of the content entry to post a comment to.
	,	$uniID			// <int> The UniID that is posting the comment.
