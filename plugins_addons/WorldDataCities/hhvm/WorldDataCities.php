...
# Note: License requires: "This product includes data created by MaxMind, available from http://www.maxmind.com"
	...
	(
		string $pathToFile			// <str> The path to the CSV file of world city data.
	,	int $startPos = 0		// <int> The position to start at.
	,	int $limitNum = 50000	// <int> The number of 
...
/****** Get city data by city name ******/
	...
	(
		string $queryString		// <str> The query string to use to search for the appropriate city.
	): array <int, mixed>						// RETURNS <int:mixed> the full list of city data between these gps boundaries.
...
/****** Get city data within a particular GPS area ******/
	...
	(
		int $latitudeMin		// <int> The minimum latitude.
	,	int $latitudeMax		// <int> The maximum latitude.
	,	int $longitudeMin		// <int> The minimum longitude.
	,	int $longitudeMax		// <int> The maximum longitude.
	): array <int, mixed>						// RETURNS <int:mixed> the full list of city data between these gps boundaries.
