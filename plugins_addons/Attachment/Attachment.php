...
/****** Constructor for an Attachment ******/
	...
	(
		$type = 0		// <int> The type of attachment being created.
	,	$assetURL = ""	// <str> The URL where the attachment resides.
	)					// RETURNS <int> ID of the attachment on success, and 0 if failed.
...
/****** Save the Attachment ******/
	...
	)					// RETURNS <void> SETS $this->id to the attachment ID
...
/****** Retrieve Attachment ******/
	...
	(
		$attachmentID		// <int> The ID of the attachment to retrieve data for.
	)						// RETURNS <str:mixed> data extracted from the attachment, or array() on failure.
...
/****** Find and retrieve the attachment ID ******/
	...
	(
		$assetURL		// <str> The original asset that the attachment used.
	,	$sourceURL		// <str> The source URL that the attachment used.
	,	$title = ""		// <str> If set, will also look by the title.
	)					// RETURNS <int> the ID of the attachment, or 0 on failure.
...
/****** Extract Image Data from the Attachment ******/
	...
	(
		$attachment		// <str:str> The base attachment data.
	)					// RETURNS <str:str> data of the attachment on success, or empty array on failure.
...
/****** Prepare Video Settings from a Video URL ******/
	...
	(
		$videoURL		// <str> The URL of the video to embed.
	)					// RETURNS <str> The embed code for the video, or "" on failure.
...
/****** Extract Video Image from a Video URL ******/
	...
	(
		$videoURL		// <str> The URL of the video to extract images from.
	)					// RETURNS <str> The embed code for the video, or "" on failure.
