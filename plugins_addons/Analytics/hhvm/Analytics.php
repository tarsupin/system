...
/****** Run a Page View Tracker (tracks the current page view into analytics) ******/
	...
	(
		int $backupDuration = 5184000	// <int> Duration to backup logs after (default: 60 days)
	): void								// RETURNS <void>
...
/****** Run a Custom Analytics Tracker (tracks your custom tracker into analytics) ******/
	...
	(
		string $trackerName				// <str> The name of the custom tracker
	,	int $backupDuration = 5184000	// <int> Duration to backup logs after (default: 60 days)
	): void								// RETURNS <void>
...
/****** Prune Analytics Data ******/
	...
	(
		int $backupDuration			// <int> The duration (in seconds) of backup logs to store (e.g. "past 60 days")
	,	string $type = "page-views"	// <str> The type of analytics to back up (page-views, custom-trackers, etc.)
	): void							// RETURNS <void>
