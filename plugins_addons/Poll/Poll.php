...
/****** Retrieve a poll's question ******/
	...
	)				// RETURNS <str:mixed> the poll details.
...
/****** Retrieve a poll's options ******/
	...
	(
		$pollID		// <int> The ID of the poll.
	)				// RETURNS <str:mixed> the poll options.
...
/****** Retrieve a poll's rules ******/
	...
	(
		$question	// <str:mixed> The poll data.
	)				// RETURNS <str:mixed> the poll rules.
...
/****** Retrieve a poll's standings ******/
	...
	(
		$pollID		// <int> The ID of the poll.
	)				// RETURNS <str:mixed> the poll standings ordered by score and votes.
...
/****** Retrieve a poll's participants ******/
	...
	(
		$pollID			// <int> The ID of the poll.
	,	$authorID = 0	// <int> The ID of the poll author.
	)					// RETURNS <str:mixed> the poll participants.
...
/****** Check whether the user has voted ******/
	...
	(
		$pollID		// <int> The ID of the poll.
	,	$uniID = 0	// <int> The ID of the user. Defaults to Me::$id.
	)				// RETURNS <str:mixed> The participant's vote.
...
/****** Check whether someone is allowed to vote in the poll ******/
	...
	(
		$pollID		// <int> The ID of the poll.
	,	$start = 0	// <int> The start time of the poll.
	,	$end = 0	// <int> The end time of the poll.
	)				// RETURNS <bool> TRUE on allowed voting, FALSE otherwise.
...
/****** Check whether someone is allowed to edit the poll ******/
	...
	(
		$pollID		// <int> The ID of the poll.
	)				// RETURNS <str:mixed> the poll details on allowed usage, array() otherwise.
...
/****** Check whether someone is allowed to view the poll standings ******/
	...
	(
		$pollID		// <int> The ID of the poll.
	)				// RETURNS <bool> TRUE on allowed usage, FALSE otherwise.
...
/****** Check whether someone is allowed to view the poll participants ******/
	...
	(
		$pollID		// <int> The ID of the poll.
	,	$authorID	// <int> The ID of the poll author.
	)				// RETURNS <int> 0 if not allowed, 1 if only allowed to view the names, 2 if allowed to view votes too
...
/****** Create a poll ******/
	...
	(
		$title						// <str> The poll title.
	,	$description				// <str> The question.
	,	$date_start					// <int> The start time.
	,	$date_end					// <int> The end time.
	,	$max_choices = 1			// <int> The max number of options a participant may pick.
	,	$priority_weight = false	// <bool> Whether to weight options according to priority.
	,	$view_standings = "closed"	// <str> "closed", "vote" or "public", whether participants may see the standings in an ongoing poll.
	,	$randomize_display = false	// <bool> Whether to show the options in random order while voting.
	,	$requirements = array()		// <mixed> An array of any requirements for participation in the poll.
	)								// RETURNS <int> The ID of the new poll.
...
/****** Add an option ******/
	...
	(
		$pollID						// <int> The ID of the poll.
	,	$text						// <str> The option text to add.
...
/****** Delete an option ******/
	...
	(
		$pollID						// <int> The ID of the poll.
	,	$optionID					// <int> The option being removed.
	)								// RETURNS <bool> TRUE on success, FALSE on failure.
...
/***** Move an option *****/
	...
	(
		$pollID						// <int> The ID of the poll.
	,	$optionID					// <int> The option being moved.
...
/***** Edit an option *****/
	...
	(
		$pollID						// <int> The ID of the poll.
	,	$optionID					// <int> The option being edited.
	,	$text						// <str> The new option text.
	)								// RETURNS <bool> TRUE on success, FALSE otherwise
...
/****** Edit a poll ******/
	...
	(
		$pollID						// <int> The ID of the poll to edit.
	,	$title						// <str> The poll title.
	,	$description				// <str> The question.
	,	$date_start					// <int> The start time.
	,	$date_end					// <int> The end time.
...
/***** Output for poll *****/
	...
	(
		$pollID						// <int> The ID of the poll.
	,	$extra = false				// <bool> TRUE to include the title, FALSE if the script handles it
	)								// RETURNS <str> The html for the poll or an empty string on failure.
...
/***** Output for standings *****/
	...
	(
		$standings					// <str:mixed> The standings.
	)								// RETURNS <str> The output html.
...
/***** Vote in poll *****/
	...
	(
		$pollID						// <int> The ID of the poll.
	,	$rules						// <str:mixed> The rules of the poll.
	,	$data						// <str:mixed> The vote data.
	)								// RETURNS <bool> TRUE on success, FALSE on failure.
...
/***** Remove a vote *****/
	...
	(
		$pollID						// <int> The ID of the poll.
	,	$uniID						// <int> The ID of the user whose vote gets removed.
	)								// RETURNS <bool> TRUE on success, FALSE on failure.
