...
/****** Get a list of groups that a user belongs to ******/
	...
	(
		int $groupID	// <int> The GroupID to get data for.
	): array <str, str>				// RETURNS <str:str> the group data retrieved.
...
/****** Get a list of users in a group ******/
	...
	(
		int $groupID			// <int> The GroupID from which to retrieve a list of users.
	,	int $minClearance = 0	// <int> The minimum level of clearance a user needs to be returned in this list.
	,	int $maxClearance = 9	// <int> The maximum level of clearance a user needs to be returned in this list.
	): array <int, int>						// RETURNS <int:int> list of users in the group and their corresponding clearance.
...
/****** Get a list of groups that a user belongs to ******/
	...
	(
		int $uniID		// <int> The UniID to retrieve a list of groups of.
	): array <int, int>				// RETURNS <int:int> list of users owned by that AuthID, array() if none.
