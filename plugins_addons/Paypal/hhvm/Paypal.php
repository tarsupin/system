...
/****** Run a Transaction ******/
	...
	(
		array $postData		// <array> The Post Data of the transaction.
...
/****** Get Data from a Transaction ******/
	...
	(
		int $txnID			// <int> The Transaction ID of the transaction.
		string $columns = "*"	// <str> The columns to retrieve from the transaction.
	): array <str, mixed>					// RETURNS <str:mixed> the transaction data
...
/****** Prepare the UniID of the user for the custom paypal value ******/
	...
	(
		int $uniID		// <int> The UniID to pass to paypal.
	): string				// RETURNS <str> an encrypted value to pass as the custom value.
...
/****** Get the UniID of the user from the custom paypal value ******/
	...
	(
		string $customValue	// <str> The custom value that was sent to paypal to identify the UniID.
	): int					// RETURNS <int> the user's UniID, or 0 on failure.
...
/****** Update a Transaction Status ******/
	...
	(
		int $txnID		// <int> The ID of the transaction.
	,	string $status		// <str> The status to set the transaction to.
	): bool				// RETURNS <bool> TRUE on success, FALSE on failure.
...
/****** Credit the User's Account ******/
	...
	(
		array $postData			// <array> The post data of the paypal purchase.
	,	array $txnData = array()	// <array> Data that was already sent with an earlier transaction.
	): bool						// RETURNS <bool> TRUE if user was credited, FALSE if not.
