...
# The higher the ranking, the better.
	...
	,	int $votesDown		// <int> The number of negative votes received.
	,	int $actions		// <int> The number of actions performed (comments, shares).
	,	int $timePassed		// <int> The amount of time that has passed (in seconds).
	): float					// RETURNS <float> weight of the rank.
...
/****** Calculate Rank of Content Entries ******/
	...
	(
		int $views			// <int> The number of views the content has received.
	,	int $votesUp		// <int> The number of positive votes received.
	,	int $votesDown		// <int> The number of negative votes received.
	,	int $comments		// <int> The number of comments created.
	,	int $shared			// <int> The number of times the entry has been shared.
	,	float $tippedAmount	// <float> The amount in total that has been tipped to the entry.
	): float					// RETURNS <float> weight of the rank.
