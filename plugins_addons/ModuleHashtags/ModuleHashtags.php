...
/****** Retrieve a list of hashtags assigned to a Content Entry ******/
	...
	)					// RETURNS <int:str> The list of hashtags assigned to the content entry.
...
/****** Add or update a Hashtag ******/
	...
	,	$hashtag		// <str> The URL for the video.
	,	$maxHash = 12	// <int> The number of hashtags the user is allowed to have.
	)					// RETURNS <bool> TRUE if the hashtag was updated, FALSE if not.
...
/****** Delete a hashtag from a content entry ******/
	...
	(
		$contentID		// <int> The ID of the content entry to delete a hashtag from.
	,	$hashtag		// <str> The hashtag to delete.
...
/****** Indicate a list of hashtags that were submitted ******/
	...
	(
		$contentID		// <int> The ID of the content entry to submit hashtags to.
	,	$hashtags		// <int:str> The hashtags that were submitted.
	)					// RETURNS <bool> TRUE on success, FALSE on failure.
