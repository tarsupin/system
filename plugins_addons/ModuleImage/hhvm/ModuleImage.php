...
/****** Plugin Variables ******/
	public static string $type = "Image";					// <str>
	
	// Available Styles
	public static string $defaultClass = "content-img";	// <str> The default style to apply for this block.
...
/****** Draw the Form for the active Image Block ******/
	...
	// ModuleImage::draw($blockID);
	{
		...
		echo '
				...
				<p>Image credit: <input type="text" name="credits[' . $blockID . ']" value="' . $result['credits'] . '" placeholder="" size="64" maxlength="72" tabindex="10" autocomplete="off" /></p>
			</div>
		</div>';
	}
...
/****** Update an Image Block ******/
	...
	(
		int $contentID		// <int> The ID of the content entry.
	,	int $blockID		// <int> The ID of the block.
	,	string $imageURL		// <str> The URL of the image.
	,	string $caption		// <str> The caption to set for the block.
	,	string $credits		// <str> The credits to set for the block.
...
/****** Delete the image ******/
	...
	(
		string $imageURL		// <str> The URL of the image to delete.
	): bool					// RETURNS <bool> TRUE on success, FALSE on failure.
