...
/****** Get Content Entry ******/
	...
	(
		$contentID		// <int> The ID of the content entry to retrieve.
	)					// RETURNS <str:mixed> The data array for the content entry.
...
/****** Get Content Entry ******/
	...
	(
		$status				// <int> The data for the content that you're validating clearance for.
	,	$ownerID			// <int> The UniID of the person who created the content.
	)						// RETURNS <void>
...
/****** Queue a content entry for approval ******/
	...
	(
		$contentID		// <int> The ID of the content entry to queue for approval.
...
/****** Approve a content entry in the queue ******/
	...
	(
		$contentID		// <int> The ID of the queued content entry to approve.
	)					// RETURNS <bool> TRUE on success, FALSE on failure.
...
/****** Deny a content entry in the queue ******/
	...
	(
		$contentID		// <int> The ID of the queued content entry to deny.
	)					// RETURNS <bool> TRUE on success, FALSE on failure.
...
# main image used (or video) and the heading text.
	...
	(
		$contentID			// <int> The ID of the block to retrieve.
	,	$blocksToScan = 4	// <int> The number of blocks to scan.
	)						// RETURNS <str:mixed> the core data for the article.
...
/****** "Chat This Content" Action ******/
	...
	(
		$contentInfo	// <int:int> The data for the content that we're chatting.
	)					// RETURNS <bool> TRUE on success, FALSE on failure.
...
/****** "Share This Content" Button ******/
	...
	(
		$contentID		// <int> The content ID of the content entry you're sharing.
	,	$type = "blog"	// <str> The type of content being chatted.
	)					// RETURNS <str> the URL of the share link.
...
/****** "Vote" Button ******/
	...
	(
		$contentID		// <int> The content ID of the content entry you're voting on.
...
/****** "Vote" Action ******/
	...
	(
		$voteData		// <int:mixed> The voting data that you passed.
	)					// RETURNS <bool> TRUE on success, FALSE on failure.
...
/****** "Flag Content" Button ******/
	...
	(
		$contentID		// <int> The content ID of the content entry you're flagging.
	)					// RETURNS <str> the URL of the share link.
...
/****** "Vote" Action ******/
	...
	(
		$voteData		// <int:mixed> The flag data that you passed.
	)					// RETURNS <bool> TRUE on success, FALSE on failure.
