...
/****** "Chat This Content" Action ******/
	...
	(
		array <int, mixed> $contentInfo	// <int:mixed> The data for the content that we're chatting.
	): bool					// RETURNS <bool> TRUE on success, FALSE on failure.
...
/****** "Share This Content" Action ******/
	...
	(
		array <int, mixed> $contentInfo	// <int:mixed> The data for the content that we're sharing.
	): bool					// RETURNS <bool> TRUE on success, FALSE on failure.
