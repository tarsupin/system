...
/****** Save a set of boolean values into a single integer for storage ******/
	...
	(
		array <int, bool> $booleanList	// <int:bool> A list of booleans to save into a single number
	): int					// RETURNS <int> the integer value to save.
...
/****** Save a set of boolean values into a single integer for storage ******/
	...
	(
		int $integer		// <int> The integer value to extract boolean values from.
	,	int $boolCount		// <int> The number of boolean values considered for the extraction.
	): array <int, bool>					// RETURNS <int:bool> the list of boolean values.
...
# This code is a modified and optimized version of code originally provided by Coder4web and wolfe on Stack Overflow.
	public static function toWord	<T> // <T>
	(
		T $number		// <T> The number that you'd like to translate to a word.
	): string				// RETURNS <str> Word (or phrase) of the number you translated.
...
/****** Private Helper ******/
	...
	(
		int $number		// <int> The single digit that you'd like to translate to a word.
	): string				// RETURNS <str> the single number as a word.
...
/****** Private Helper ******/
	...
	(
		int $number		// <int> The two digits that you'd like to translate to a word.
	): string				// RETURNS <str> the result as a word.
...
/****** Private Helper ******/
	...
	(
		int $numberLength	// <int> The length of the number being converted.
	,	int $number			// <int> The number you'd like to translate to a word.
	): string					// RETURNS <str> the result as a word.
