...
/****** Plugin Variables ******/
	private static string $envType = "";				// <str> Gets set to "development" or "production"
	private static array <int, mixed> $instructions = array();	// <int:mixed> A list of instructions to submit.
