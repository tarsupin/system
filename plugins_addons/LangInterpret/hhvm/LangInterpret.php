...
/****** Plugin Variables ******/
	...
	public int $letterCount = 0;			// <int> The number of letters contained in the text.
	public int $numberCount = 0;			// <int> The number of numbers contained in the text.
	public int $punctuationCount = 0;		// <int> The number of simple punctuation characters in the text.
	public int $symbolCount = 0;			// <int> The number of symbols in the text.
	
	public int $vowelCount = 0;				// <int> The number of vowels in the text.
	public int $consonantCount = 0;			// <int> The number of consonants in the text.
	
	public int $capitalLetterCount = 0;		// <int> The number of capitalized letters.
	public int $capitalWordCount = 0;		// <int> The number of capitalized words (first letter).
	public int $allCapsWordCount = 0;		// <int> The number of fully capitalized words.
	
	public int $spaceCount = 0;				// <int> The number of spaces in the text.
	public int $tabCount = 0;				// <int> The number of tabs in the text.
	public int $whitespaceCount = 0;		// <int> The number of whitespace entries in the text.
	
	// Tense
	public int $pastTenseCount = 0;			// <int> The number of words that indicate past tense.
	public int $presentTenseCount = 0;		// <int> The number of words that indicate present tense.
	public int $futureTenseCount = 0;		// <int> The number of words that indicate future tense.
	
	// Attitude
	public int $negativeCount = 0;			// <int> The number of words that indicate anger, hostility, negativity.
	public int $positiveCount = 0;			// <int> The number of words that indicate positivity.
	
	// Derived Information
	public int $nounCount = 0;				// <int> People, places, or things.
	public int $pronounCount = 0;			// <int> Replaces a noun.
	public int $verbCount = 0;				// <int> Action or state.
	public int $adverbCount = 0;			// <int> Describes a verb, adjective, or another adverb.
	public int $adjectiveCount = 0;			// <int> Describes a noun.
	public int $prepositionCount = 0;		// <int> Links a noun to another word.
	public int $conjunctionCount = 0;		// <int> Joins clauses or sentances.
	public int $interjectionCount = 0;		// <int> Short exclamation.
	
	// Specific Derivations for Nouns
	public int $properNounCount = 0;		// <int> Names specific people, places, or things.
	public int $commonNounCount = 0;		// <int> Names non-specific people, places, or things.
	public int $concreteNounCount = 0;		// <int> Nouns you can perceive.
	public int $abstractNounCount = 0;		// <int> Nouns you cannot percieve with your senses.
	
	public int $placesCount = 0;			// <int> Nouns that are places.
	public int $peopleCount = 0;			// <int> Nouns that are people.
	public int $objectCount = 0;			// <int> Nouns that are objects.
	
	public int $singularNounCount = 0;		// <int> Nouns that name one person, place, thing, or idea.
	public int $pluralNounCount = 0;		// <int> Nouns that name multiple things.
	public int $collectiveNounCount = 0;	// <int> Nouns that are a group of something (gaggle, flock, group, etc)
	public int $possessiveNounCount = 0;	// <int> Nouns that show ownership.
	
	// Specific Derivations for Pronouns
	public int $firstPersonCount = 0;		// <int> References to "me" or "I"
	public int $secondPersonCount = 0;		// <int> References to "you"
	public int $thirdPersonCount = 0;		// <int> References to third party words: "he", "she", "they"
	public int $thirdPersonSingleCount = 0;	// <int> References to third party words: "he", "she"
	public int $thirdPersonGroupCount = 0;	// <int> References to third party groups: "they"
	
	// Specific Derivations for Verbs
	public int $lexicalVerbCount = 0;		// <int> Action verbs
...
/****** Plugin Constructor ******/
	...
	(
		string $text		// <str> The text to interpret
	): void				// RETURNS <void>
