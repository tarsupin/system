...
/****** Process the widget's behavior ******/
	...
	(
		string $hashtag			// <str> The hashtag that this widget uses to filter the appropriate content.
	,	array <int, str> $categories			// <int:str> The categories that this featured content widget will call from.
	,	int $slots = 2			// <int> The number of slots to show in featured content.
	,	int $totalViews = 100	// <int> The total number of views that this widget should show before refreshing.
	): void						// RETURNS <void>
