...
/****** Plugin Variables ******/
	public string $confirmValue = "";	// <str> The value used to validate the confirmation entry.
	
	public bool $passed = false;		// <bool> Gets set to TRUE once the validation passes.
	public string $type = "";			// <str> The confirmation type being used (if applicable).
	public array <str, mixed> $data = array();		// <str:mixed> The data stored with the confirmation (if applicable).
	public int $dateCreated = 0;	// <int> The date that the confirmation was created.
	
	
/****** Delete a Confirmation Entry ******/
	public function __construct
	(
		string $confirmValue	// <str> The value being used to validate the confirmation entry.
	): bool					// RETURNS <bool> TRUE on validate, FALSE on failure.
...
/****** Create Confirmation Entry ******/
	...
	(
		string $confirmVal			// <str> The confirmation value to assign.
	,	array <str, mixed> $confirmData = array()	// <str:mixed> Extra data to assign to this confirmation entry.
	,	int $expires = 7200		// <int> Seconds until the confirmation expires (default: 2 hours). 0 for no expiration.
	): bool						// RETURNS <bool> TRUE on a successful creation, FALSE on failure.
