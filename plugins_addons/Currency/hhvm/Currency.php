...
/****** Check how much of a currency the user has ******/
	...
	(
		int $uniID		// <int> The Uni-ID to check.
	): mixed				// RETURNS <mixed> The amount of currency the user has, FALSE on error.
...
/****** Add currency to the user (from the system) ******/
	...
	(
		int $uniID				// <int> or <str> The ID or username of the user to give currency to.
	,	float $amount				// <float> Sets how much currency to add to the user.
	...
	): mixed						// RETURNS <mixed> The new balance, or FALSE on error.
...
/****** Subtract credits from the user (from the system) ******/
	...
	(
		int $uniID				// <int> The Uni-Account to subtract credits from.
	,	float $amount				// <float> Sets how many credits to subtract to the user.
	,	string $desc = ""			// <str> The description of the transaction, if applicable.
	,	&$errorStr = false	// <var> A variable to return error strings with.
	): mixed						// RETURNS <mixed> The new balance, or FALSE on error.
...
/****** Exchange currency between two users ******/
	...
	(
		int $uniIDFrom			// <int> The Uni-Account of the user sending currency.
	,	int $uniIDTo			// <int> The Uni-Account receiving currency.
	,	float $amount				// <float> Sets how much currency to exchange.
	,	string $desc = ""			// <str> The description of the transaction, if applicable.
	,	&$errorStr = false	// <var> A variable to return error strings with.
	): mixed						// RETURNS <mixed> The balances of each user, or FALSE on error.
