...
/****** Plugin Variables ******/
	public static string $type = "Author";			// <str>
	
	
/****** Get the data about the author ******/
	public static function get
	(
		int $authorID		// <int> The UniID of the author.
	): array <str, str>					// RETURNS <str:str> the data array of each content entry for a related content slot.
...
/****** Set the data about an author ******/
	...
	(
		int $authorID		// <int> The UniID of the author.
	,	string $blurb			// <str> The blurb (short message) about the author.
...
/****** Show the widget for the author's details ******/
	...
	(
		int $authorID		// <int> The UniID of the author.
	,	int $sidePos = 30	// <int> The position in the sidebar to show this widget in.
	): void					// RETURNS <void>
