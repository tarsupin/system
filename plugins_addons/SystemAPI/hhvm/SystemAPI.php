...
/****** API Variables ******/
	...
	public int $microCredits = 100000;		// <int> The cost in microcredits (1/10000 of a credit) to access this API.
...
/****** Run the API ******/
	...
	): array <str, mixed>					// RETURNS <str:mixed> site info on success, array() on failure.
