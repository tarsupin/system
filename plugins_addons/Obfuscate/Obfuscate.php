...
/****** Plugin Variables ******/
	public static $removeWhitespace = true;			// <bool> TRUE will remove unnecessary whitespace.
	public static $removeComments = true;			// <bool> TRUE will remove comments.
	public static $obfuscateVariables = true;		// <bool> TRUE will obfuscate all variables.
	
	public static $reservedValue = array('$this', '$_GET', '$_POST', '$_FILES', "true", "false", "self", "__call", "__callStatic", "__construct");		// <int:str> A list of reserved values to skip obfuscation on.
	
	
/****** Run the Obfuscatation Algorithm ******/
	public static function run
	(
		$phpCode		// <str> The php code to obfuscate.
...
/****** Obfuscate a File ******/
	...
	(
		$filepath		// <str> The filepath of the file to obfuscate.
	,	$savepath		// <str> The filepath of where to save the new obfuscated file.
	)					// RETURNS <bool> TRUE on success, FALSE on failure.
...
/****** Return an obfuscated variable name ******/
	...
	(
		$variable		// <str> The variable to obfuscate.
	)					// RETURNS <str> The obfuscated form of the variable.
