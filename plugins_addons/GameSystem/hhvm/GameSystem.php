...
/****** Place an object onto a map ******/
	...
	(
		int $mapID				// <int> The ID of the map to place an object instance on.
	,	float $x					// <float> The X position to place an object instance on.
	,	float $y					// <float> The Y position to place an object instance on.
	,	string $object				// <str> The object to place.
	,	string $objectType = ""	// <str> The object type to place (if specifying a type).
	,	int $objectID = 0		// <int> The ID of the object to place (if placing a specific object).
...
/****** Delete an object from the map ******/
	...
	(
		int $instanceID			// <int> The ID of the map instance.
	): bool						// RETURNS <bool> TRUE on success, FALSE on failure.
...
/****** Delete all objects from an area within a map ******/
	...
	(
		int $mapID					// <int> The ID of the map to delete objects from.
	,	float $x						// <float> The X position to consider the left-most area of deletion.
	,	float $y						// <float> The Y position to consider the top-most area of deletion.
	,	float $toX					// <float> The X position to consider the right-most area of deletion.
	,	float $toY					// <float> The Y position to consider the right-most area of deletion.
	,	bool $deleteFlags = false	// <bool> TRUE to delete flags in this area as well.
	): bool							// RETURNS <bool> TRUE on success, FALSE on failure.
