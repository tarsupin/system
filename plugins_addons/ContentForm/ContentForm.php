...
/****** Plugin Variables ******/
	public $baseURL = "";			// <str> The base URL of the Content Form
	public $contentID = 0;			// <int> The ID of the content entry being worked on.
	public $contentData = array();	// <str:mixed> The data of the content entry.
	public $blockID = 0;			// <int> The ID of the active content block being modified.
	public $action = "";			// <str> The action / behavior to run.
	public $type = "";				// <str> The active module type.
	
	// Default Modules
	public $modules = array(			// <str:bool> A list of modules to load into this content form.
		"Hashtags"		=> self::MODULE_TYPE_META
	,	"Text"			=> self::MODULE_TYPE_SEGMENT
	,	"Image"			=> self::MODULE_TYPE_SEGMENT
	,	"Video"			=> self::MODULE_TYPE_SEGMENT
	...
	public static $contentType = "blog";	// <str> The type of content entry (blog, article, etc)
	
	public $guestPosts = true;		// <bool> TRUE if there are guest posts on this site.
	public $privatePosts = false;	// <bool> TRUE if there are private posts allowed on this site.
	public $maxStatus = 4;			// <int> The maximum status level (e.g. Content::STATUS_GUEST)
	
	public $urlPrefix = "";			// <str> Set this value to indicate the prefix to a URL slug.
	public $urlFixed = "";			// <str> If set, this forces the URL to be a specific value.
	public $urlClearance = 0;		// <int> The level of clearance the writer has regarding the URL.
	public $urlReassign = false;	// <bool> TRUE if you are allowed to reassign URL's after making them public.
	
	public $blockLimit = 25;		// <int> The total number of blocks that this form is limited to.
	public $pagination = 1;			// <int> The total number of pages that this content can allow.
	
	public $useHashtags = false;	// <bool> TRUE to allow hashtags.
	public $useComments = false;	// <bool> TRUE to allow comments.
	public $useVoting = false;		// <bool> TRUE to allow voting.
...
/****** Content Form Constructor ******/
	...
	(
		$baseURL		// <str> The base URL of the Content Form to submit to.
	,	$contentID = 0	// <int> The ID of the content entry being worked on.
...
# This method runs during the entry update process.
	...
	(
		$customData		// <str:mixed> The custom data to submit to the method.
	)					// RETURNS <bool> TRUE to continue with update, FALSE to end update sequence.
...
# This method runs during the entry deletion process.
	...
	)					// RETURNS <bool> TRUE to continue with deletion, FALSE to end deletion sequence.
...
/****** Verify access to modifying this content entry ******/
	...
	(
		$redirectTo		// <str> The URL to redirect to if verification fails.
	)					// RETURNS <void> outputs the appropriate data.
...
/****** Update a Content Entry ******/
	...
	,	$title				// <str> The title of the entry.
	,	$urlSlug			// <str> The url slug to assign the entry to.
	,	$status = 0			// <int> The current status to assign to the entry (e.g. Content::STATUS_DRAFT).
	,	$clearanceView = 0	// <int> The clearance required to view this entry.
	,	$clearanceEdit = 0	// <int> The clearance required to edit this entry.
	,	$datePosted = 0		// <int> The date that this entry has been posted (0 is ignore this).
	,	$primeHashtag = ""	// <int> Assigns a primary hashtag, if applicable ("" to ignore).
	,	$comments = 2		// <int> The type of comments to set.
	,	$voting = 2			// <int> The type of voting to set.
...
/****** Delete a content entry and all of the other pieces related to it ******/
	...
	(
		$contentID		// <int> The ID of the content entry to delete
	)					// RETURNS <bool> TRUE on success, FALSE on failure.
...
/****** Create a Content Block Segment ******/
	...
	(
		$contentID		// <int> The ID of the content entry to assign this text block to.
	,	$type			// <str> The type of segment being created (e.g. TYPE_TEXT, TYPE_IMAGE, etc.)
	,	$blockID		// <int> The ID of the block that needs to be created.
	)					// RETURNS <int> the sort order of the new segment, or 0 on failure.
...
/****** Delete a Content Segment ******/
	...
	(
		$contentID		// <int> The ID of the content entry assigned to this segment piece.
	,	$type = 0		// <int> The type of the segment.
	,	$blockID = 0	// <int> The ID of the block associated with this segment piece.
	)					// RETURNS <bool> TRUE on success, FALSE on failure.
