...
/****** Plugin Variables ******/
	...
	public $settings = array(		// <str:bool> A list of setting modules to load.
		"Hashtags"		=> true
	,	"Author"		=> true
	,	"Search"		=> true
	,	"Related"		=> true
	...
	public $segments = array(		// <str:bool> A list of segment modules to load.
		"Text"			=> true
	,	"Image"			=> true
	,	"Video"			=> true
	);
	...
	public $contentType = "blog";	// <str> The type of content entry (blog, article, etc)
	public $baseURL = "";			// <str> The base URL of the Content Form
	public $redirectOnError = "";	// <str> The page to redirect to if there's an error.
	...
	public $openPost = false;		// <bool> TRUE if guests can post officially on this site.
	public $privatePosts = false;	// <bool> TRUE if there are private posts allowed on this site.
	
	public $comments = 4;			// <int> The level of commenting allowed.
	public $voting = 4;				// <int> The level of voting allowance.
	
	// Values that the system sets
	public $urlLength = 55;			// <int> The maximum length allowed with the URL.
...
/****** Create a Content Block Segment ******/
	...
	)					// RETURNS <int> the ID of the block, or 0 on failure.
