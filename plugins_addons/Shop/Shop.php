...
/****** Create a shop category ******/
	...
	(
		$category				// <str> The category name (and identifier).
	,	$parentCategory = ""	// <str> The Parent Category of this category, if applicable.
	,	$isVisible = true		// <bool> TRUE if the category is visible (listed publicly).
	,	$isAccessible = true	// <bool> TRUE if the category is accessible.
	)							// RETURNS <bool> TRUE if created, FALSE if there was an error.
...
/****** Create inventory that could be utilized in the shop ******/
	...
	(
		$title				// <str> The title of the inventory.
	,	$blurb				// <str> A quick blurb about the inventory.
	,	$cost				// <float> The cost of the inventory (in credits).
	)						// RETURNS <bool> TRUE if created, FALSE if there was an error.
...
/****** Get Inventory Data ******/
	...
	(
		$inventoryVar	// <int> or <str> The ID (or slug) of the inventory to get data on.
	,	$columns = "*"	// <str> The columns to retrieve from the table.
	)					// RETURNS <str:mixed> data on the inventory.
...
/****** Get Inventory Data of listed items ******/
	...
	(
		$category		// <str> The category to get inventory data from the items in.
	,	$columns = "*"	// <str> The columns to retrieve from the table.
	,	$startPage = 1	// <int> The starting page of the pagination value.
	,	$limit = 30		// <int> The number of items to return.
	)					// RETURNS <int:[str:mixed]> data on the inventory.
...
/****** List an Inventory Item ******/
	...
	(
		$category				// <str> The category name (and identifier).
	,	$inventoryID			// <int> The Inventory ID to list.
	)							// RETURNS <bool> TRUE if created, FALSE if there was an error.
...
/****** List a random Inventory Item ******/
	...
	(
		$category		// <str> The category to add a random item to.
	)					// RETURNS <bool> TRUE if item was added, FALSE if there was an error.
...
/****** List timer inventories, if available ******/
	...
	(
		$category			// <str> The category to add all timer items to.
	)						// RETURNS <bool> TRUE if an item was added, FALSE if not.
...
/****** Add an inventory item to the random queue ******/
	...
	(
		$category				// <str> The category name (and identifier).
	,	$inventoryID			// <int> The Inventory ID to list.
	,	$weight = 100			// <int> The weight of the random item (100 is base).
