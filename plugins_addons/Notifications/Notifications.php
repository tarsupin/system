...
/****** Create a Global Notification ******/
	...
	,	$url				// <str> The URL to use for the notification.
	,	$sync = true		// <bool> TRUE to sync this global update with Auth.
	)						// RETURNS <bool> TRUE on success, FALSE on failure.
...
/****** Get Global Notifications ******/
	...
	(
		$page = 1			// <int> The current page of notifications to view.
	,	$numToShow = 20		// <int> The number of global notifications to return.
	)						// RETURNS <int:[str:str]> the list of global notifications, FALSE on failure.
...
/****** Notifications Widget (for the sidebar) ******/
	...
	)				// RETURNS <str> HTML of a sidebar widget (or hidden), FALSE on failure.
...
# Note: Only some notifications actually get sent to Auth. Many are local only.
	...
	(
		$lastSyncTime		// <int> The timestamp of the last sync.
	)						// RETURNS <int> The updated sync time.
