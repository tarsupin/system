...
/****** Get a list of entry IDs based on a list of hashtags ******/
	...
	(
		array <int, str> $hashtagList		// <int:str> An array of hashtags that we're going to pull entry IDs from.
	,	int $startPage = 1		// <int> The starting page.
	,	int $rowsPerPage = 15	// <int> The number of entries to return per page.
	): array <int, int>						// RETURNS <int:int> a list of the content IDs based on recent posts.
...
/****** Get a list of the recent entry IDs (such as for the home page) ******/
	...
	(
		int $status = 0		// <int> The minimum status allowed for content entries.
	): array <int, int>					// RETURNS <int:int> a list of the content IDs based on recent posts.
...
/****** Get a list of the the user's entry IDs ******/
	...
	(
		int $uniID				// <int> The UniID to get the list of posts from.
	,	int $startPage = 1		// <int> The starting page.
	,	int $rowsPerPage = 15	// <int> The number of entries to return per page.
	): array <int, int>						// RETURNS <int:int> a list of the content IDs based on the user's posts.
