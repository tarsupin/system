...
/****** Plugin Variables ******/
	public static string $returnURL = "";		// <str> The URL to return to after a button has been clicked.
	
	
/****** "Friend Me" Button ******/
	public static function addFriend
	(
		int $friendID		// <int> The UniID of the person to add as a friend.
	): string					// RETURNS <str> URL link for the add friend, or "" on failure.
...
/****** "Friend Me" Action ******/
	...
	,	int $clearance = 0	// <int> The clearance to run with (automatically passed).
...
/****** "Share on Social" Action ******/
	...
	(
		array <str, mixed> $packet			// <str:mixed> The packet to send to UniFaction for sharing purposes.
	): bool					// RETURNS <bool> TRUE on success, FALSE on failure.
...
/****** "Follow Me" Button ******/
	...
	(
		int $uniID			// <int> The UniID of the person to add as a friend.
	): string					// RETURNS <str> HTML output for the button.
