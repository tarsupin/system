...
/****** Zip a Directory ******/
	...
	(
		string $source				// <str> The path to the file or directory to zip.
	,	string $targetFile			// <str> The filepath where you would like to save the .zip file.
	,	bool $incParent = false	// <bool> If TRUE, include the base parent directory in the zip.
...
/****** Unzip a Zipped File into a Directory ******/
	...
	(
		string $sourceFile			// <str> The filepath of the file to unzip.
	,	string $targetDirectory	// <str> The filepath where you would like to place the files that result.
	): bool						// RETURNS <bool> TRUE on success, FALSE otherwise.
