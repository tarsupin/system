...
/****** Return the URL Segments for this Page Load ******/
	...
	(
		$url = ""	// <str> The URL that you want to get the segments of; default is the current URL.
	)				// RETURNS <int:mixed> segments of the URL provided (e.g. "domain.com/{segment1}/{segment2}");
