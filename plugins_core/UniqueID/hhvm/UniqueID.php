...
/****** Return a new UniqueID ID ******/
	...
	(
		string $name = "unique"		// <str> The name of the address tracker to use (e.g. "thread", "post", etc)
	): int							// RETURNS <int> the numeric ID to provide. 0 means it failed.
...
/****** Adds a new unique address tracker ******/
	...
	(
		string $name		// <str> The name of the address tracker to create (e.g. "thread", "post", etc)
