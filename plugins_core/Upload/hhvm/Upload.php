...
/****** Plugin Variables ******/
	...
	public int $maxFileSize = 2097152;			// <int> the maximum file size allowed (default: 2 megabytes)
	public array <int, str> $allowedMimes = array();			// <int:str> the allowed mime types
	public array <int, str> $allowedExtensions = array();	// <int:str> the allowed extensions
	public int $maxFilenameLength = 22;			// <int> the maximum filename length to allow
	
	// Upload Data
	public string $extension = "";			// <str> the file's extension
	public string $toExtension = "";		// <str> the extension to save the file to
	public string $mimeType = "";			// <str> the mime type of the file
	public bool $valid = true;			// <bool> TRUE if the file is valid and can be uploaded
	public int $filesize = 0;			// <int> the file size of the image to be uploaded
	
	// Directory Data
	public string $tempPath = "";			// <str> the temporary path where the image was uploaded to
	public string $saveDirectory = "";		// <str> the path where the image will be saved to
	public string $filename = "";			// <str> the name of the image
	
	// Upload Save Modes
	public int $saveMode = 0;			// <int> the active saving mode (rules for overwrite, rename, etc)
...
/****** Make sure the file data is valid ******/
	...
	): bool					// RETURNS <bool> TRUE if successful, FALSE if there were errors.
...
/****** Validate the path to upload to ******/
	...
	): bool					// RETURNS <bool> TRUE if the validation is successful, FALSE if not.
...
/****** Get the file location to retrieve something at ******/
	...
	(
		int $numericalValue		// <int> The numerical value of the integer to separate the files.
	,	string $filename			// <str> The filename of the image.
	,	string $ext				// <str> The extension of the image.
	,	string $size = ""			// <str> The size that you'd like to return the image in.
	,	int $divide = 2500		// <int> The amount to divide by for the bucket's purposes.
	): string						// RETURNS <str> the source file of the image.
...
/****** Get the data for the file location that you'll use ******/
	...
	(
		int $numericalValue		// <int> The numerical value of the integer to separate the files.
	,	int $divide = 2500		// <int> The amount to divide by for the bucket's purposes.
	): array <str, mixed>						// RETURNS <str:mixed> the data for the source directories of the image.
