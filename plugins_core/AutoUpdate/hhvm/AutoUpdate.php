...
/****** Plugin Variables ******/
	public static string $updateSite = "unifaction";	// <str> The site to get updates from.
	public static int $updateDuration = 172800;		// <int> Time (in seconds) to pass before checking updates.
...
/****** Check the last time the site updated ******/
	...
	): int				// RETURNS <int> the timestamp of the last update, or 0 on failure.
...
/****** Check if there are any updates ******/
	...
	): array <str, str>				// RETURNS <str:str> the list of updates that need to be done, or array() if none.
