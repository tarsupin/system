...
/****** Secure Random Integer ******/
	...
	(
		$length	= 32		// <int> The length of the integer that you'd like to return.
	)						// RETURNS <int> A random integer key of the desired length (string format).
...
/****** Purify a URL, Prevent XSS ******/
	...
	(
		$unsafeURL		// <str> The URL that you want to clean.
	)					// RETURNS <str> The safe URL.
