...
/****** Plugin Variables ******/
	public $slots = array();		// <int:[int:array]> Stores links in a navigational structure.
	
	
/****** Load navigation links from the database ******/
	public function loadFromDatabase
	(
		$group		// <str> Load the navigation links from this particular group.
	)				// RETURNS <void>
...
/****** Add a link to this navigation object ******/
	...
	,	$url				// <str> The URL to visit when the link is clicked.
	,	$class				// <str> The name of the CSS class to associate with this link.
	,	$sortOrder = 99		// <int> The sort order to position this link into.
	)						// RETURNS <void>
