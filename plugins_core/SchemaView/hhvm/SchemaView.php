...
/****** Plugin Variables ******/
	public string $table = '';					// <str> The table to pull for this schema view.
	public array <int, array<int, str>> $filters = array();			// <int:[int:str]> The "where" filters to restrict the row results.
	public array <int, array<int, str>> $sorts = array();			// <int:[int:str]> The "order by" sort options.
	
	public int $currentPage = 1;			// <int> The current page of the schema view.
	public int $rowsToShow = 30;			// <int> The number of rows to show.
	
	public string $sqlCount = "";				// <str> The SQL command to run to get the row count.
	public string $sql = "";					// <str> The SQL command to run to return the visible rows.
	public array <int, mixed> $sqlArray = array();			// <int:mixed> The SQL array to enter into the selection query.
	
	public array $structure = array();		// <array> The full structure of all field entries in our schema.
	public array $prepColumns = array();		// <array> The columns (and data) pulled for this schema view.
	public array $saveData = array();			// <array> Extra data to save, such as uni_ids.
	
	public string $baseURL = "";				// <str> The base URL to this page.
	public string $urlPage = "";				// <str> The URL query string for the current page.
	public string $editLink = "";				// <str> The preparation link for editing.
	public string $deleteLink = "";			// <str> The preparation link for deleting.
	
	public string $fieldIndex = "";			// <str> The unique field to use for editing and deleting rows.
	public bool $allowEdit = false;			// <bool> Whether or not to allow editing of rows.
	public bool $allowDelete = false;		// <bool> Whether or not to allow deletion of rows.
	public bool $autoDelete = false;			// <bool> TRUE allows instant deletions, FALSE requires confirmation.
	
	
/****** Construct the SchemaView class ******/
	public function __construct
	(
		string $table		// <str> The table to use for this schema view.
	,	string $baseURL	// <str> The base URL for this schema view.
	): void				// RETURNS <void>
...
/****** Add a field to this view, with options for special parameters ******/
	...
	(
		string $field		// <str> The field to add to this view.
...
/****** Add a filter: only fields that match the requirements will show ******/
	...
	(
		string $field			// <str> The field to add as a filter.
	,	string $comparison		// <str> The comparison string to use (e.g. "=", ">=", "<=", etc).
	,	mixed $value			// <mixed> The value to match for this filter.
	): bool					// RETURNS <bool>
...
/****** Add a sort value to the schema view ******/
	...
	(
		string $field			// <str> The field to add to the sort.
	,	string $dir = "ASC"	// <str> The direction to sort.
	): bool					// RETURNS <bool> TRUE on success, FALSE on failure.
...
/****** Display Pagination Links ******/
	...
	): mixed					// RETURNS <mixed> the pagination class.
