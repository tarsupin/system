...
/****** Plugin Variables ******/
	...
	public static array <str, mixed> $jsData = array(			// <str:mixed> Special javascript data to save.
		"key"		=> ""
	);
...
/****** Handle special javascript chatting functionality ******/
	...
	): string				// RETURNS <str> the text to use for special javascript functionality.
