...
/****** Plugin Variables ******/
	public $table = "";			// <str> The table that we're accessing for this schema call.
	public $field = "";			// <str> The field that we're accessing for this schema call.
...
/****** Construct the schema define class ******/
	...
	(
		$table			// <str> The table whose schema you are defining.
	,	$reset = false	// <bool> Flushes the entire schema of the table you're defining.
	)					// RETURNS <void>
...
/****** Set values on the field schema ******/
	...
	,	$args		// <int:mixed> The arguments being called.
	)				// RETURNS <this>
...
/****** A helper function for updating the field list ******/
	...
	,	$value			// <mixed> The value to set the column to.
	)					// RETURNS <this>
...
/****** Set what selection to pull from ******/
	...
	(
		$pullType		// <str> The pull type ("select", "method", "database", etc).
	,	$pullFrom		// <mixed> The location to pull from, such as within the selection arguments.
	)					// RETURNS <this>
...
/****** Validate a field type ******/
	...
	(
		$fieldType		// <str> The field type that you're attempting to add.
	)					// RETURNS <str> the valid field type.
...
/****** Flush an entire table schema ******/
	...
	(
		$table			// <str> The name of the table to flush.
...
/****** Add a selection option ******/
	...
	(
		$selectName		// <str> The name of the selection schema to add
	,	$key			// <mixed> The value of the key for the selection.
	,	$title			// <str> The value of the title for the selection's key.
	)					// RETURNS <bool> TRUE on success, FALSE on failure.
