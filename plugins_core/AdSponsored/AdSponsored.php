...
/****** Plugin Variables ******/
	public $visible = false;		// <bool> TRUE if the ad is visible, FALSE otherwise.
	public $adShown = 0;			// <int> The ID of the ad to show.
	
	
/****** Constructor ******/
	public function __construct
	(
		$structure				// <str> The ad structure (which defines the ad type, size, and other rules)
	,	$zone					// <str> The name of the ad zone.
	,	$keyword = ""			// <str> The reference ID for the ad.
	,	$description = ""		// <str> The description of the ad, so that others can identify what it's purpose is.
	,	$onMobile = false		// <bool> TRUE to run this ad on mobile devices.
	,	$onTablet = true		// <bool> TRUE to run this ad on tablet devices.
	,	$onDesktop = true		// <bool> TRUE to run this ad on desktop devices.
	,	$runAd = true			// <bool> TRUE if the ad is set to continue running (false to safely end over time).
	)							// RETURNS <void>
...
/****** Prepare the advertisement ******/
	...
	)						// RETURNS <bool> TRUE if the ad is prepared successfully, FALSE otherwise.
...
/****** Run the advertisement ******/
	public function run (
	)						// RETURNS <str> The HTML for the advertisement.
...
/****** Generate the URL that an advertisement is going to use ******/
	...
	,	$url		// <str> The URL that the advertisement is destined to arrive at.
	)				// RETURNS <str> The URL to load the promote site.
...
/****** Return a full ad placement code ******/
	...
	)						// RETURNS <str> The ad code for this ad.
...
/****** Return a hash locator for ads ******/
	...
	,	$zone				// <str> The ad zone.
	,	$keyword = ""		// <str> The targeted keyword.
	,	$audience = ""		// <str> The audience to target ("all", "user", "premium", etc).
	)						// RETURNS <str> The ad hash to use for locating advertisements.
...
/****** Run an image advertisement ******/
	...
	(
		$adData			// <str:mixed> An array that contains the data about this ad.
	,	$structure		// <str:mixed> An array that contains the structure data for the ad.
	)					// RETURNS <str> The HTML for the advertisement.
