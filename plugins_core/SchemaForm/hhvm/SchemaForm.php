...
/****** Plugin Variables ******/
	public string $table = '';					// <str> The table to use for this form.
	public string $baseURL = "";				// <str> The base URL to use for the links in this form.
	
	public array <str, mixed> $structure = array();		// <str:mixed> Stores schema data for all of the available fields.
	public array <str, mixed> $formPrep = array();			// <str:mixed> Stores schema data for fields used in the form.
	public array <int, str> $formSlots = array();		// <int:str> Stores HTML of each input built with the form.
	
	
/****** Construct the SchemaForm class ******/
	public function __construct
	(
		string $table		// <str> The table to use for this form.
	,	string $baseURL	// <str> The base URL to use for links with this form.
	): void				// RETURNS <void>
...
/****** Validate a form submission ******/
	...
	): bool				// RETURNS <bool> TRUE if the submission will pass, FALSE on failure.
...
/****** Add a field to this form, with ability to designate options ******/
	...
	(
		string $field		// <str> The field to add to this form.
					// (args of options and modes)
	): bool				// RETURNS <bool> TRUE on success, FALSE on failure.
