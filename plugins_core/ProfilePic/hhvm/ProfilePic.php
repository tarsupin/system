...
/****** Return ProfilePic Image ******/
	...
	(
		int $uniID				// <int> The UniID that you'd like to show the profile pic of.
	,	string $size = "small"		// <str> The size of the profile pic you'd like to return ("small", "medium", or "large").
	): string						// RETURNS <str> URL of the profile pic to display.
...
/****** Get Profile Picture Data ******/
	...
	(
		int $uniID				// <int> The UniID that you'd like to get profile pic data for.
	,	string $size = "small"		// <str> The size of the profile pic you'd like to return data for.
	): array <str, str>						// RETURNS <str:str> data pertaining to the profile pic's image.
...
/****** Return Site Icon Image ******/
	...
	(
		string $siteHandle			// <str> The site handle that you'd like to show the icon of.
	,	string $size = "small"		// <str> The size of the site icon you'd like to return ("small", "medium", or "large").
	): string						// RETURNS <str> URL of the site icon to display.
...
/****** Get Site Icon Data ******/
	...
	(
		string $siteHandle			// <str> The site handle that you'd like to show the avatar of.
	,	string $size = "small"		// <str> The size of the site icon you'd like to return data for.
	): array <str, str>						// RETURNS <str:str> data pertaining to the site's image.
