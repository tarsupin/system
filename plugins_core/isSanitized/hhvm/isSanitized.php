...
/****** Call Static ******/
	...
	(
		string $name			// <str> The method that will be called.
	,	array <int, mixed> $arguments		// <int:mixed> The arguments being passed.
	): bool					// RETURNS <bool> TRUE if there were nothing unsanitized, FALSE if there was.
	{
