...
# This empowers a comment to use Hashtags and Notifications with other Users.
	...
	,	string $sourceURL = ""			// <str> The link to this particular comment.
	,	int $responseToUniID = 0	// <int> The UniID of the target being commented to.
	,	array <str, mixed> $hashData = array()		// <str:mixed> The data necessary to process information for the hashtag.
...
/****** Show comment syntax, which adds links to user handles and hashtags ******/
	...
	,	string $baseHandleSite = ""	// <str> The base site (url) to link handles to.
	): string							// RETURNS <str> The message with appropriate links.
...
/****** Checks if the comment contains users ******/
	...
	(
		string $comment	// <str> The comment that you want to dig through for users marked as alerted.
	): bool				// RETURNS <bool> TRUE if there are users marked.
...
/****** Return user handles listed in the message (e.g. @MyHandle, @JoeSmith) ******/
	...
	(
		string $comment	// <str> The comment that you want to dig through for users marked as alerted.
	): array <int, str>				// RETURNS <int:str> of users that were marked for alert.
