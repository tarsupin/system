...
/****** Plugin Variables ******/
	...
	public array <int, str> $allowedMimes = array("image/jpeg", "image/pjpeg", "image/png", "image/gif");	// <int:str> the allowed mime types for this upload
	public array <int, str> $allowedExtensions = array("jpg", "png", "gif");		// <int:str> the allowed extensions for this upload
	
	public int $minWidth = 50;			// <int> the minimum image width allowed on this upload
	public int $maxWidth = 3000;		// <int> the maximum image width allowed on this upload
	public int $minHeight = 50;			// <int> the minimum image height allowed on this upload
	public int $maxHeight = 3000;		// <int> the maximum image height allowed on this upload
	
	// Image Data
	public int $quality = 90;			// <int> The quality (0 to 100) of the image (for jpg files)
	public int $width = 0;				// <int> the width of the image
	public int $height = 0;				// <int> the height of the image
	public int $scale = 1;				// <int> the scale of the resulting image (width / height).
...
/****** Save the image ******/
	...
	(
		string $savePath = ""	// <str> The path to save the image to.
