...
/****** Plugin Variables ******/
	public string $useragent = "";			// <str>
	public string $httpaccept = "";			// <str>
	...
	public int $initCompleted = 0;			// <int>
	public int $isWebkit = 0;				// <int>
	public int $isMobilePhone = 0;			// <int>
	public int $isIphone = 0;				// <int>
	public int $isAndroid = 0;				// <int>
	public int $isAndroidPhone = 0;			// <int>
	public int $isTierTablet = 0;			// <int>
	public int $isTierIphone = 0;			// <int>
	public int $isTierRichCss = 0;			// <int>
	public int $isTierGenericMobile = 0;	// <int>
	
	// Initialize some initial smart phone string variables.
	public string $engineWebKit = 'webkit';				// <str>
	
	public string $deviceIphone = 'iphone';				// <str>
	public string $deviceIpod = 'ipod';					// <str>
	public string $deviceIpad = 'ipad';					// <str>
	public string $deviceMacPpc = 'macintosh';				// <str>
	
	public string $deviceAndroid = 'android';				// <str>
	public string $deviceGoogleTV = 'googletv';			// <str>
	public string $deviceHtcFlyer = 'htc_flyer';			// <str>
	
	public string $deviceWinPhone7 = 'windows phone os 7';	// <str>
	public string $deviceWinPhone8 = 'windows phone 8';		// <str>
	public string $deviceWinMob = 'windows ce';				// <str>
	public string $deviceWindows = 'windows';					// <str>
	public string $deviceIeMob = 'iemobile';					// <str>
	public string $devicePpc = 'ppc';							// <str> Stands for PocketPC
	public string $enginePie = 'wm5 pie';						// <str> An old Windows Mobile
	
	public string $deviceBB = 'blackberry';					// <str>
	public string $deviceBB10 = 'bb10';						// <str> For the new BB 10 OS
	public string $vndRIM = 'vnd.rim';							// <str> Detectable when BB devices emulate IE or Firefox
	public string $deviceBBStorm = 'blackberry95';				// <str> Storm 1 and 2
	public string $deviceBBBold = 'blackberry97';				// <str> Bold 97x0 (non-touch)
	public string $deviceBBBoldTouch = 'blackberry 99';		// <str> Bold 99x0 (touchscreen)
	public string $deviceBBTour = 'blackberry96';				// <str> Tour
	public string $deviceBBCurve = 'blackberry89';				// <str> Curve2
	public string $deviceBBCurveTouch = 'blackberry 938';		// <str> Curve Touch
	public string $deviceBBTorch = 'blackberry 98';			// <str> Torch
	public string $deviceBBPlaybook = 'playbook';				// <str> PlayBook tablet
	
	public string $deviceSymbian = 'symbian';			// <str>
	public string $deviceS60 = 'series60';				// <str>
	public string $deviceS70 = 'series70';				// <str>
	public string $deviceS80 = 'series80';				// <str>
	public string $deviceS90 = 'series90';				// <str>
	
	public string $devicePalm = 'palm';				// <str>
	public string $deviceWebOS = 'webos';				// <str> For Palm's line of WebOS devices
	public string $deviceWebOShp = 'hpwos';			// <str> For HP's line of WebOS devices
	public string $engineBlazer = 'blazer';			// <str> Old Palm browser
	public string $engineXiino = 'xiino';				// <str> Another old Palm
	
	public string $deviceNuvifone = 'nuvifone';		// <str> Garmin Nuvifone
	public string $deviceBada = 'bada';				// <str> Samsung's Bada OS
	public string $deviceTizen = 'tizen';				// <str> Tizen OS
	public string $deviceMeego = 'meego';				// <str> Meego OS
	
	public string $deviceKindle = 'kindle'; 			// <str> Amazon Kindle, eInk one
	public string $engineSilk = 'silk-accelerated';	// <str> Amazon's accelerated Silk browser for Kindle Fire
	...
	public string $deviceTablet = 'tablet';				// <str> Generic term for slate and tablet devices
	public string $deviceBrew = 'brew';					// <str>
	public string $deviceDanger = 'danger';				// <str>
	public string $deviceHiptop = 'hiptop';				// <str>
	public string $devicePlaystation = 'playstation';		// <str>
	public string $devicePlaystationVita = 'vita';			// <str>
	public string $deviceNintendoDs = 'nitro';				// <str>
	public string $deviceNintendo = 'nintendo';			// <str>
	public string $deviceWii = 'wii';						// <str>
	public string $deviceXbox = 'xbox';					// <str>
	public string $deviceArchos = 'archos';				// <str>
	
	public string $engineOpera = 'opera';					// <str> Popular browser
	public string $engineNetfront = 'netfront';			// <str> Common embedded OS browser
	public string $engineUpBrowser = 'up.browser';			// <str> common on some phones
	public string $engineOpenWeb = 'openweb';				// <str> Transcoding by OpenWave server
	public string $deviceMidp = 'midp';					// <str> a mobile Java technology
	public string $uplink = 'up.link';						// <str>
	public string $engineTelecaQ = 'teleca q';				// <str> a modern feature phone browser
	public string $engineObigo = 'obigo';					// <str>W 10 is a modern feature phone browser
	
	public string $devicePda = 'pda';						// <str> some devices report themselves as PDAs
	public string $mini = 'mini';							// <str> Some mobile browsers put 'mini' in their names.
	public string $mobile = 'mobile';						// <str> Some mobile browsers put 'mobile' in their user agent strings.
	public string $mobi = 'mobi';							// <str> Some mobile browsers put 'mobi' in their user agent strings.
	
	//Use Maemo, Tablet, and Linux to test for Nokia's Internet Tablets.
	public string $maemo = 'maemo';						// <str>
	public string $linux = 'linux';						// <str>
	public string $qtembedded = 'qt embedded';				// <str> for Sony Mylo and others
	public string $mylocom2 = 'com2';						// <str> for Sony Mylo also
	
	//In some UserAgents, the only clue is the manufacturer.
	public string $manuSonyEricsson = "sonyericsson";		// <str>
	public string $manuericsson = "ericsson";				// <str>
	public string $manuSamsung1 = "sec-sgh";				// <str>
	public string $manuSony = "sony";						// <str>
	public string $manuHtc = "htc";						// <str>
	
	//In some UserAgents, the only clue is the operator.
	public string $svcDocomo = "docomo";					// <str>
	public string $svcKddi = "kddi";						// <str>
	public string $svcVodafone = "vodafone";				// <str>
	
	//Disambiguation strings.
	public string $disUpdate = "update";					// <str> pda vs. update
