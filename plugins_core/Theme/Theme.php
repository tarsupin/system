...
/****** Plugin Variables ******/
	public static $dir = "";				// <str> tracks the directory of the theme
	public static $home = "/";				// <str> tracks the base home URL (when redirecting to "home")
	
	public static $theme = "default";		// <str> the active theme being used
	public static $style = "default";		// <str> the active style being used
	public static $layout = "default";		// <str> the layout to load
	public static $view = "";				// <str> the view page to load
	
	public static $controllerPath = "";		// <str> the file path to the controller to load.
	public static $layoutPath = "";			// <str> the file path to the layout to load.
	public static $viewPath = "";			// <str> the file path to the view page to load.
	
	
/****** Set the active theme ******/
	public static function set
	(
		$theme					// <str> The theme to set as active.
	,	$style = "default"		// <str> The style that you want to set.
	,	$layout = "default"		// <str> The layout that you want to assign.
	)							// RETURNS <void>
...
/****** Set the active theme controller to use ******/
	...
	(
		$controller		// <str> The controller to load.
	,	$plugin = ""	// <str> If set, this runs a plugin's controller.
	,	$baseHome = ""	// <str> If set, this is the base URL of the home for this controller (used for plugins).
	)					// RETURNS <str> The file path to the controller page.
...
/****** Set the active theme layout to use ******/
	...
	(
		$layout		// <str> The layout to set as active.
	)				// RETURNS <str> The file path to the layout page.
...
/****** Set the active view page to load ******/
	...
	(
		$view		// <str> The view page to load.
	)				// RETURNS <str> The file path to the layout page.
...
/****** Load a theme file ******/
	...
	(
		$page		// <str> The layout to load.
	,	$type		// <str> The type of page to load (controller, layout, page, etc).
	)				// RETURNS <str> the path to the file being loaded.
...
/****** Get the list of available themes ******/
	...
	)				// RETURNS <int:str> the list of available themes
...
/****** Get the list of available themes ******/
	...
	(
		$theme		// <str> The theme to check the available styles of.
	)				// RETURNS <int:str> the list of available styles in the theme
...
/****** Check if a theme is available (exists) on the site ******/
	...
	(
		$theme		// <str> The theme that you want to verify exists.
	)				// RETURNS <bool> TRUE if the theme is available, FALSE if not.
...
/****** Check if a theme has the indicated style ******/
	...
	(
		$style			// <str> The style that you're checking exists within the theme.
	,	$theme = ""		// <str> The theme to look for the style in (default is your active theme).
	)					// RETURNS <bool> TRUE if the style is part of the theme, FALSE if not.
