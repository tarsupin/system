...
/****** Class Variables ******/
	public static bool $pass = true;				// <bool> If set to FALSE, this abruptly ends Migrations
	public static float $currentVersion = 0.00;	// <float> This gets set to the current migration version
	public static float $lastVersion = 0.00;		// <float> Saves the last successful migration value (in case float $pass fails)
	public static float $newVersion = 0.00;		// <float> The newest migration value (may get listed as faulty)
	
	
/****** Add an entry to the migration list ******/
	public static function getVersion (
	): float				// RETURNS <float> the current version of the site.
...
/****** Add an entry to the migration list ******/
	...
	(
		float $version	// <float> The version that you're migrating.
	,	string $desc = ""	// <str> Description for this migration.
	): bool				// RETURNS <bool> TRUE if updating, FALSE if not.
