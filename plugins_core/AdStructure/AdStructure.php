...
/****** Plugin Variables ******/
	public static $adDetails = array();			// <str:mixed> The array of ad details for this ad structure.
	
	public static $detailStruct = array(		// <str:mixed> A reset version the $adDetails array.
		"name"				=> "Advertisement"
	,	"type"				=> ""
	,	"desc"				=> ""
	,	"responsive"		=> false
...
/****** Generate the rules of the ad based on the structure designated ******/
	...
	)						// RETURNS <str:mixed> The details for this ad's structure.
...
/****** Define rules based on the structure provided ******/
	...
	(
		$structureData		// <str> The data for this structure.
	)						// RETURNS <void>
