...
/****** Plugin Variables ******/
	public static $pluginPages = array();		// <str:[str:mixed]>
...
/****** Check if a Plugin Exists ******/
	...
	(
		$plugin			// <str> The dependency plugin that you need to prepare
...
/****** Load a Plugin Config ******/
	...
	(
		$plugin			// <str> The name of the plugin whose admin class needs to be loaded.
	,	$dir = ""		// <str> A strict directory to look it for plugins; disallows any other paths if set
...
/****** Get a Plugin Directory ******/
	...
	(
		$plugin			// <str> The name of the plugin to retrieve the path of
	)					// RETURNS <str> Path to the plugin if found, or "" on failure.
...
/****** Retrieve a list of the Plugin's Admin Pages ******/
	...
	(
		$pluginPath = ""	// <str> The base plugin directory to retrieve admin pages from.
...
/****** Retrieve a list of Plugin Schemas ******/
	...
	(
		$pluginPath = ""	// <str> The base plugin directory to scan for schema files.
	)						// RETURNS <int:str> an array of schema names contained in the directory provided.
...
/****** Run a plugin's action (if applicable) ******/
	...
	(
		$plugin			// <str> The plugin to run the action for
	,	$action			// <str> The name of the plugin's action to run.
...
/****** Run a plugin's behavior (if applicable) ******/
	...
	(
		$plugin			// <str> The plugin to run the behavior for
	,	$behavior		// <str> The name of the plugin's behavior to run.
...
/****** Check if a Plugin has installations to run ******/
	...
	(
		$plugin					// <str> The plugin that you need to check if it has an installation process.
	,	$pluginConfig = null	// <mixed> The plugin config object, if already active.
