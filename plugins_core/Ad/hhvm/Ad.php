...
/****** Plugin Variables ******/
	public float $visitCPM = 0.45;		// <float> The minimum credit cost for 1000 views from a visitor.
	public float $userCPM = 2.45;			// <float> The minimum credit cost for 1000 views from registered users.
	public float $targetCPM = 4.95;		// <float> The minimum credit cost for 1000 views from targeted users.
	...
	*/
	...
	public string $structure = "";			// <str> The structure of ad, which defines the type of ad and its rules.
	public string $type = "";				// <str> The type of ad ("text", "image", etc);
	public string $zone = "";				// <str> The name of the ad zone.
	public string $keyword = "";			// <str> The keyword associated with the ad (if applicable).
	public string $description = "";		// <str> The description of the ad.
	
	public bool $premium = false;		// <bool> Set to TRUE if you've identified that this is a premium view.
	
	public bool $mobile = true;			// <bool> TRUE if this ad is displayed on mobile.
	public bool $desktop = true;			// <bool> TRUE if this ad is displayed on desktop.
	
	
/****** Load the ad structure ******/
	public function loadStructure
	(
		string $structure		// <str> The structure to load.
	): void					// RETURNS <void>
