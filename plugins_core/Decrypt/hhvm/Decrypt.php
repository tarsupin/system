...
/****** Decrypt Data ******/
	...
	(
		string $key 			// <str> The original key that was used for the encryption.
	,	string $encryptedData	// <str> The data to decrypt.
	): string					// RETURNS <str> the decrypted string (or garbage, if decrypted improperly).
...
/****** `default` Decryption Algorithm ******/
	...
	(
		string $key 			// <str> The original key that you used to encrypt the data.
	,	string $encryptedData	// <str> The data to decrypt.
	): string					// RETURNS <str> The decrypted string (or garbage, if decrypted improperly).
