...
/****** Prepare Special Tags for a Form ******/
	...
	(
		string $uniqueIdentifier = ""		// <str> You can pass test a unique identifier for form validation.
	,	int $expiresInMinutes = 300		// <int> Duration until the form is no longer valid. (default is 5 hours)
	): string								// RETURNS <str> HTML to insert into the form.
...
/****** Validate a Form Submission using Special Protection ******/
	...
	(
		string $uniqueIdentifier = ""	// <str> You can specify a unique identifier that the form validation requires.
