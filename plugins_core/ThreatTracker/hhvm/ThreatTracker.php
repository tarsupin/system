...
/****** Plugin Variables ******/
	public static bool $trackInput = false;		// <bool> Whether or not to track unsanitized input
	public static bool $trackActivity = false;	// <bool> Whether or not to track suspicious activity
	public static int $minSeverity = 1;			// <int> The minimum severity level to track
...
/****** Set the ThreatTracker Mode ******/
	...
	(
		int $mode = 0		// <int> The mode to set.
	,	int $severity = 1	// <int> The severity level to track.
	): void					// RETURNS <void>
...
/****** Log data into ThreatTracker ******/
	...
	(
		string $threatType				// <str> The type of threat being tracked (e.g. "input", "activity", etc.)
	,	int $severity				// <int> The level of danger that is assumed by phpTesla about the data
	,	string $threatText				// <str> The most relevant message associated with the potential threat
	,	array <int, str> $threatData = array()	// <int:str> The data that you want to track as a potential threat
	,	string $function = ""			// <str> The class::function() being called
	,	string $params = ""			// <str> The arguments passed to the function call
	,	string $file = ""				// <str> The file that the effect was called in
	,	int $line = 0				// <int> The file line that the effect was called at
	): void							// RETURNS <void>
...
/****** Prune Threats ******/
	...
	(
		int $severity			// <int> The threat level of the data that was identified
	,	int $pruneDuration		// <int> The timestamp up to which point to prune threats
	): void						// RETURNS <void>
