...
/****** Retrieve Duration Since Last Benchmark ******/
	...
	(
		string $group = ""		// <str> Optional group name for record keeping purposes (to identify the benchmark).
	,	string $subgroup = ""	// <str> Optional subgroup to indicate changes to (or parameters of) the benchmark.
	,	string $name = ""		// <str> Optional name to indicate changes to (or parameters of) the benchmark.
	): float					// RETURNS <float> The duration (in seconds) since the last benchmark.
...
/****** Benchmark Graph ******/
	...
	(
		int $baseline = 30		// <int> The baseline in milliseconds for precision in the graph.
	): void						// RETURNS <void> OUTPUTS an HTML graph of the benchmark.
...
/****** Benchmark Graph ******/
	...
	(
		string $group = ""		// <str> Group that was used to identify and track the benchmark
	,	string $subgroup = ""	// <str> Sub-group that was used to identify and track the benchmark
	,	string $name = ""		// <str> Name that was used to identify and track the benchmark
	): void					// RETURNS <void> OUTPUTS an HTML graph of the benchmark.
